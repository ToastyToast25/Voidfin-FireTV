	...
	SettingsColumn {
		item {
			ListSection(
				...
				headingContent = { Text(stringResource(R.string.voidstream_settings)) },
			)
		}
		...
		item {
			...
			ListButton(
				...
				onClick = { router.push(Routes.VOIDSTREAM_MEDIA_BAR_CONTENT_TYPE) }
			)
		}
		...
		item {
			...
			ListButton(
				...
				enabled = mediaBarEnabled,
				onClick = { router.push(Routes.VOIDSTREAM_MEDIA_BAR_ITEM_COUNT) }
			)
		}
		...
		item {
			...
			ListButton(
				...
				enabled = mediaBarEnabled,
				onClick = { router.push(Routes.VOIDSTREAM_MEDIA_BAR_OPACITY) }
			)
		}
		...
		item {
			...
			ListButton(
				...
				enabled = mediaBarEnabled,
				onClick = { router.push(Routes.VOIDSTREAM_MEDIA_BAR_COLOR) }
			)
		}
		...
		item {
			ListButton(
				...
				onClick = { router.push(Routes.VOIDSTREAM_HOME_ROWS_IMAGE) }
			)
		}
		...
		item {
			ListButton(
				...
				onClick = { router.push(Routes.VOIDSTREAM_SYNCPLAY) }
			)
		}
	}
}
