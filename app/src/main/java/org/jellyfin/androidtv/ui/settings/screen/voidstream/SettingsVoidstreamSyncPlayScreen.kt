...
@Composable
fun SettingsVoidStreamSyncPlayScreen() {
    ...
    SettingsColumn {
        ...
        item {
            ...
            ListButton(
                ...
                onClick = { router.push(Routes.VOIDSTREAM_SYNCPLAY_MIN_DELAY) }
            )
        }
        ...
        item {
            ...
            ListButton(
                ...
                enabled = useSpeedToSync,
                onClick = { router.push(Routes.VOIDSTREAM_SYNCPLAY_MAX_DELAY) }
            )
        }
        ...
        item {
            ...
            ListButton(
                ...
                enabled = useSpeedToSync,
                onClick = { router.push(Routes.VOIDSTREAM_SYNCPLAY_DURATION) }
            )
        }
        ...
        item {
            ...
            ListButton(
                ...
                onClick = { router.push(Routes.VOIDSTREAM_SYNCPLAY_MIN_DELAY_SKIP) }
            )
        }
        ...
        item {
            ...
            ListButton(
                ...
                onClick = { router.push(Routes.VOIDSTREAM_SYNCPLAY_EXTRA_OFFSET) }
            )
        }
    }
}
